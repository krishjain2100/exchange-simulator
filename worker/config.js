...
module.exports = {
    ...
    CORE_DIR,
    WORK_DIR,
    BOT_REPLAY_BINARY: process.env.BOT_REPLAY_BINARY || path.join(__dirname, 'bot_replay'),
    VERIFIER_BINARY: process.env.VERIFIER_BINARY || path.resolve(__dirname, 'verifier'),
    ...
    DOCKER_HARD_LIMIT_MS: 480000,
    DOCKER_MAX_MEMORY_MB: 4096,
    DOCKER_MAX_CPUS: 4,
    PHASE1_TIMEOUT_MS: 30000,
    PHASE1_FORCE_STOP_MS: 120000,
    PHASE1_LOAD_FAILURE_MSG: 'Engine could not finish Phase 1 within 60s',
};
